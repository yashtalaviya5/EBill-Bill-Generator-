    ...
    public class Data : IData
    {
        ...
        public void SaveBillDetails(BillDetail details)
        {
            ...
            try
            {
                ...
                decimal subTotal = details.Items.Sum(i => i.Price * i.Quantity);
                decimal gst = subTotal * 0.18m; // 18% GST
                details.TotalAmount = subTotal + gst;
        ...
        public List<BillDetail> GetAllDetail()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    detail.TotalAmount = decimal.Parse(reader["TotalAmount"].ToString());
        ...
        public BillDetail GetDetail(int Id)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    item.Quantity = decimal.Parse(reader["Quantity"].ToString());
